					...
					<div class="fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16">
						...
						<div class="w-screen max-w-2xl">
							<form
								...
								on:submit|preventDefault={sendMeasurement}
							>
								<div class="flex-1">
									<!-- Header -->
										...
										<div class="flex items-start justify-between space-x-3">
											<div class="space-y-1">
												...
												<p class="text-sm text-gray-500">
													Наш специалист свяжется с вами для обсуждения деталей в удобное для вас
													время. Услуга бесплатная!
												</p>
											</div>
									...
									<div class="relative m-3 h-40 sm:h-56">
										<img
										...
										>
											...
											<div class="sm:col-span-2">
												<input
													...
													name="project-name"
													id="name"
													class="block h-8 w-full rounded-md border border-gray-300 p-2 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm"
												/>
											</div>
										</div>
										<!-- Project name -->
										...
										>
											...
											<div class="sm:col-span-2">
												<textarea
													...
													rows="3"
													class="block w-full rounded-md border border-gray-300 p-2 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm"
												/>
											</div>
										</div>
								...
								<div class="flex-shrink-0 px-4   py-5 sm:px-6">
									<div class="flex justify-end space-x-3">
										...
										<button
											type="submit"
											class="inline-flex justify-center rounded-md border border-transparent bg-gradient-to-r from-green-600 to-cyan-700 py-2 px-4 text-sm font-medium text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
										>
											Отправить
										</button>
									</div>
