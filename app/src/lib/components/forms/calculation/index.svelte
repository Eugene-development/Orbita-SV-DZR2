...
{#if visibleFormCalculation}
    ...
    -->
		...
		>
			<div class="absolute right-0 h-7 p-4">
				<button
			...
			<div class=" h-full  flex-none flex-col divide-y divide-gray-100 overflow-y-auto sm:flex">
				...
				<div class="flex flex-auto flex-col justify-between p-6">
					<div
						class="relative mb-6 rounded-md border border-gray-300 px-3 py-2 shadow-sm focus-within:border-sky-600 focus-within:ring-1 focus-within:ring-sky-600"
					>
						<label
							for="name"
					...
					<button
						type="button"
						class="mt-6 w-full rounded-md border border-transparent bg-sky-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
						>Отправить на обсчёт</button
					>
				</div>
			</div>
			...
			<div class="py-8 px-6 text-center text-sm sm:px-14">
				...
				<img class="mx-auto h-16 w-auto" src="/logo-header.png" alt="logo" />
