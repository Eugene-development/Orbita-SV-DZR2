	...
	<div class="max-w-7xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
		<div class="pr-16 sm:text-center sm:px-16">
			<p class="font-medium text-white antialiased">
				<span class="md:hidden">Специальные цены на утеплитель 905р.</span>
				<span class="hidden md:inline"> Спецпредложение. Только в эти выходные! Специальные цены на утеплитель 905р и пароизоляцию 635р.</span>
