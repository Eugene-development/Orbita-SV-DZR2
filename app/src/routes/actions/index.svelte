<div>
	<div
		class="from-blueGray-300 mx-auto mb-4 bg-gradient-to-b to-gray-50 p-10 shadow-lg sm:px-6 lg:px-8"
	>
		<div class="flex w-full flex-col text-center">
			<h1 class=" title-font text-5xl font-medium text-gray-900">Акции</h1>
		</div>
	</div>

	<div class="mx-auto mt-20 max-w-7xl sm:px-6 lg:px-8">
		<div class="text-center">
			<p class="text-base font-semibold uppercase leading-6 tracking-wide text-teal-800" />
			...
			<p class="mt-4 max-w-7xl text-xl leading-7 text-gray-500 lg:mx-auto">
				Для приобретения данной группы товаров по специальной цене свяжитесь с нашим менеджером по
				телефону
			</p>
			<div class="">
				...
				<!--              stroke-width="2"/>-->
				<!--          </svg>-->
				<p class="m-4 animate-pulse text-5xl font-bold text-red-900">8 (930) 688-88-62</p>
			</div>
		</div>
	</div>
				...
				>
					...
					<div class="relative">
						<div class="sm:text-center">
							...
							<p class="mx-auto mt-6 max-w-2xl text-lg text-indigo-200">*при наличном платеже</p>
						</div>
					</div>
				</div>
			</div>
